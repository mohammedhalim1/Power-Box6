...
-- =====================================================
-- 13. UTILITY FUNCTIONS FOR UPDATED_AT TIMESTAMPS
-- =====================================================
...
CREATE TRIGGER update_hero_section_updated_at BEFORE UPDATE ON hero_section FOR EACH ROW EXECUTE PROCEDURE update_updated_at_column();
CREATE TRIGGER update_why_choose_section_updated_at BEFORE UPDATE ON why_choose_section FOR EACH ROW EXECUTE PROCEDURE update_updated_at_column();
CREATE TRIGGER update_product_gallery_updated_at BEFORE UPDATE ON product_gallery FOR EACH ROW EXECUTE PROCEDURE update_updated_at_column();
CREATE TRIGGER update_trust_section_updated_at BEFORE UPDATE ON trust_section FOR EACH ROW EXECUTE PROCEDURE update_updated_at_column();
CREATE TRIGGER update_offer_pricing_updated_at BEFORE UPDATE ON offer_pricing FOR EACH ROW EXECUTE PROCEDURE update_updated_at_column();
CREATE TRIGGER update_customer_reviews_updated_at BEFORE UPDATE ON customer_reviews FOR EACH ROW EXECUTE PROCEDURE update_updated_at_column();
CREATE TRIGGER update_footer_updated_at BEFORE UPDATE ON footer FOR EACH ROW EXECUTE PROCEDURE update_updated_at_column();
CREATE TRIGGER update_product_popup_updated_at BEFORE UPDATE ON product_popup FOR EACH ROW EXECUTE PROCEDURE update_updated_at_column();
CREATE TRIGGER update_exit_intent_popup_updated_at BEFORE UPDATE ON exit_intent_popup FOR EACH ROW EXECUTE PROCEDURE update_updated_at_column();
...
-- SELECT name, public FROM storage.buckets WHERE id = 'images';
...
-- ✅ 10 content tables with exact frontend data
-- ✅ 1 email subscriptions table
-- ✅ All RLS policies for public read + admin write access
-- ✅ Storage bucket 'images' with proper permissions
-- ✅ Auto-updating timestamp triggers
-- ✅ All current landing page content as seed data
--
-- Your backend now fully matches your frontend content!
-- The admin dashboard should have complete control over all sections.
-- =====================================================
